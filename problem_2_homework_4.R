...
# crime rate will rise approximately with 1.48 per unit, this estimation are
...
# the results for HS in this model can be cnosidered statistically unsignificant
...
# we can see that there are other factors which unfluence the crime rate
...
# I would recommend ti widen the model with other estimators
